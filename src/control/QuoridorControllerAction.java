...
public class QuoridorControllerAction extends ControllerAction implements EventHandler<ActionEvent> {
    ...
    private QuoridorView quoridorView;

    public QuoridorControllerAction(Model model, View view, Controller control) {
        super(model, view, control);
        // take the view parameter ot define a local view attribute with the real instance type, i.e. QuoridorView.
        quoridorView = (QuoridorView) view;
    ...
    private void setMenuHandlers() {
        ...
        quoridorView.getMenuStart().setOnAction(e -> {
            try {
                control.startGame();
            }
        ...
        quoridorView.getMenuIntro().setOnAction(e -> {
            control.stopGame();
            quoridorView.resetView();
        });
        // set event handler on the MenuQuit item
        quoridorView.getMenuQuit().setOnAction(e -> {
            System.exit(0);
        });
    }
